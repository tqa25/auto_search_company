...
> Nguồn đối chiếu: `/home/ubuntu/workspaces2/projects/auto_search_company` — chính repo này, nhánh `snapshot/ban-lasted-20260730`. Mọi số dòng code trích trong tài liệu đều đối chiếu tại đây, xác minh lần gần nhất ngày 2026-08-17.  
> Ngày cập nhật: 2026-07-29 — sửa đổi: 2026-08-17  
> Ưu tiên cao nhất: giảm chi phí tìm kiếm và thu thập dữ liệu, đồng thời có thể dừng và chạy tiếp mà không làm lại từ đầu  
> Cách làm: **sửa dần ngay trong repo này, trên một nhánh làm việc riêng** (xem mục 1 và `AGENTS.md` mục 5) — không copy sang thư mục riêng, không viết lại từ số không  
>  
> Có một thư mục tên tương tự, `auto_search_company_v1`, trên cùng máy chủ — đó là bản clone cũ của cùng repo GitHub (`tqa25/auto_search_company`), đứng ở nhánh `feature/accuracy-settings-firecrawl`, còn nguyên `SERPER_API_KEY` chưa gỡ. **Không phải nguồn đối chiếu của tài liệu này** — tên trùng tình cờ, đừng nhầm hai thư mục.
